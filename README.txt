...
Tags: woocommerce, marketing, referrals
...
A plugin for WooCommerce that empowers shop owners to find out exactly where their orders are coming from, by asking customers to provide feedback.
...
1. Upload `where-heard-for-woocommerce` to the `/wp-content/plugins/` directory
